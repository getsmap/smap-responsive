...
var config = {
		...
		ol: [
            ...
            // },
						{
                init: "L.TileLayer.WMS",
                url: "http://193.17.67.229/geoserver/lund/wms",
                options: {
                    //legend: true,
                    category: ["crawls"],
                    layerId: "schpoints",
            ...
            },
			{
                ...
                options: {
                    ...
                    opacity: 1,
                    attribution: "@ Lunds kommun",
                    popup: "<p>Beskrivning: ${linedescription}</p><p>Färdmedel: ${transptype}</p><p>Hjälm: ${headprotection}</p><p>Ålder: ${age}</p><p>Målpunkt: ${linepod}</p>",
                    zIndex: 10
                }
            },
						{
                ...
                options: {
                    ...
                    category: ["crawls"],
                    layerId: "skolor",
                    displayName: "Grundskolor Lolu",
                    layers: 'lolu_grundskolor2013_wgs84',
                    format: 'image/png',
                    featureType: "polygon",
                    selectable: true,
                    transparent: true,
