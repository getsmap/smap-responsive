...
var config = {
		...
		ol: [
            ...
            },
			{
                ...
                options: {
                    //legend: true,
                    category: ["Vård & Senior","Lunchrestaurang"],
            ...
            },
			{
                ...
                options: {
                    //legend: true,
                    category: ["Vård & Senior","Träffpunkt"],
            ...
            },
			{
                ...
                options: {
                    //legend: true,
                    category: ["Vård & Senior","Vårdboende"],
            ...
            },
			{
                ...
                options: {
                    ...
                    displayName: "Äldreboende & demensboende",
			...
			//Fnuttarna i href='${url}' i  popup: "<p><br/>${namn}</p><p><a href='${url}'>Mer information</a></p>", görvid en dålig länk att den påverkas ej, använd
			{
                ...
                options: {
                    //legend: true,
                    category: ["Vård & Senior","Områdesindelning"],
